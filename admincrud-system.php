...
<header>
    <div class="netflixLogo">
        <a id="logo" href="#home"><img src="images/LOGO.png" alt="Logo Image"></a>
    </div>
    <nav class="main-nav">
...
<!-- Edit User Modal Start -->
    <h1 style="margin-left: 40vw;">Welcome admin!</h1>
...
<script src="javascript/admincrud-system.js"></script>
<style>
    .crud {
        margin-top: 15vh;
    }
